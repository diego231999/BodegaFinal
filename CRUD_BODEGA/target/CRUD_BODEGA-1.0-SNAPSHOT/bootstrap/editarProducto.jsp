            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 static-top shadow">
                        <h1 class="text-right h3 mb-1 text-light"><strong><strong>MODIFICAR PRODUCTO</strong></strong>
                        </h1>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <TABLE class="table">
                                        ...
                                        <form id="editar" method="POST"
                                              action="<%=request.getContextPath()%>/BodegaServlet?action=editar&idproducto=<%=producto.getId()%>">
                                            <TR>
                                                <div class="form-group">
                                                    ...
                                                    <td><input name="unidades" type="text"
                                                               ...
                                                               placeholder="Cantidad..." <%=request.getParameter("unidades") != null?"value='"+request.getParameter("unidades")+"'":""%>
                                        ...
                                        <form id="eliminar" method="POST"
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-block btn-warning" data-toggle="modal"
                                                       href="#lModal1"
                ...
                <div class="modal fade" id="lModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel3">Está seguro que desea actualizar
                                    producto?</h5>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                ...
                <div class="modal fade" id="lModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel4">Está seguro que desea deshacer
                                    cambios?</h5>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
